...
public class AlunoController {
	...
	public ResponseEntity<List<Aluno>> findByNomeStarsWhith(@RequestParam String nome){
		try {
	...
	@GetMapping("/buscarTelefone")
	public ResponseEntity<List<Aluno>> buscarPorTelefone(@RequestParam String telefone) {
	    try {
	        List<Aluno> alunos = this.alunoService.buscarTelefone(telefone);  
